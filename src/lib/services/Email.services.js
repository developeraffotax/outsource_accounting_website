        ...
        <table style="width: 100%; max-width: 600px; margin: 0 auto; border-collapse: collapse; font-family: Arial, sans-serif;">
            <tr>
                <td style="background-color: #f4f4f4; padding: 20px; text-align: center;">
                    <h1 style="color: #333333; font-size: 24px;">🎉 New Customer Alert! Name:${data.company}</h1>
                </td>
            </tr>
            <tr>
                <td style="padding: 30px; background-color: #ffffff; border: 1px solid #dddddd;">
                    ...
                    <ul style="list-style: none; padding: 0;">
                        <li style="margin-bottom: 10px;">
                            <strong>Name:</strong> <span style="color: #007bff;">${data.name}</span>
                        </li>
                        <li style="margin-bottom: 10px;">
                            <strong>Company:</strong> ${data.company}
                        </li>
                        <li style="margin-bottom: 10px;">
                            <strong>Turnover:</strong> ${data.companyTurnover}
                        </li>
                        <li style="margin-bottom: 10px;">
