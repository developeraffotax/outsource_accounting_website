...
const Faqs = async () => {
  ...
  return (
    <div className="flex flex-col items-center md:items-start rounded-2xl w-11/12 md:w-2/3 bg-linear-to-r from-gray-50 to-blue-300 my-6 lg:my-12 mx-auto py-6 lg:py-12 px-6 md:px-12">
