...
const GetStarted = ({ data }) => {
  return (
    <div className="rounded-2xl flex flex-col bg-blue-100 text-center gap-6 my-3 md:my-12 mx-3 md:mx-8 lg:mx-44 2xl:mx-80 lg:my-24 py-3 md:py-8 px-3 md:px-8">
