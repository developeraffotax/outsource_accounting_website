  ...
  return (
    <section className="w-full ">
      <div className="relative h-[95vh] lg:h-[90vh] w-full flex flex-col md:flex-row items-center justify-center md:justify-between overflow-hidden ">
        ...
        {/* LEFT TEXT SECTION */}
        <div className="w-full  md:w-2/4 px-6  md:pl-16 xl:pl-34 text-white flex flex-col justify-center my-6 lg:my-12 mx-6 md:mx-8 ">
        ...
        {/* RIGHT FORM SECTION */}
        <div className="w-8/9 md:w-2/7 md:mr-25 xl:mr-43 bg-white/40 backdrop-blur-md p-3 py-4 md:p-12 rounded-xl shadow-lg mt-10 md:mt-0 my-6 lg:my-12 ">
