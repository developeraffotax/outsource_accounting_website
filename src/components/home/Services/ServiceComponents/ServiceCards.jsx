...
const ServiceCards = ({ cards }) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center place-content-center text-black bg-white gap-2 md:gap-5 w-full md:w-7/9">
