const HowWeWork = ({
  ...
  return (
    <div className="px-3 md:px-8 lg:px-44 2xl:px-54  py-12 w-full">
      <h1 className="text-center font-bold text-3xl mb-16 text-gray-800">
        {heading}
      </h1>

      <div className="grid grid-cols-1 md:grid-cols-[1.5fr_.5fr_1.5fr_.5fr_1.5fr] gap-x-0 gap-y-2 mx-auto w-full xl:w-5/6 2xl:w-4/5 font-light items-start">
