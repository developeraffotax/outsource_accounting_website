...
<footer className="w-full  h-[600px]  pt-32  bg-black text-white font-Montserrat max-lg:hidden">


<div className="w-full flex justify-around items-start px-20 max-xl:px-8 mx-auto container">
...
<div className="mt-36 text-center text-gray-300 ">
  ...
  © 2024 Outsource Accounting. All rights reserved.
          ...
          <footer className="w-full flex flex-col justify-start items-start gap-8 p-8  bg-black text-white font-Montserrat lg:hidden">

         <Link className="w-32  -ml-4" href={'/'}><Image src={Logo} alt="footer--logo-image" className="w-full" /></Link>
          ...
          <ul >
            <li className="mb-2 hover:text-purple-400 text-sm  " ><a href="tel:+0208 144 6811"><FaPhone className="inline-block mr-2   "/><span>0208 144 6811</span> </a></li>
            <li className="mb-2 hover:text-purple-400 text-sm" ><a href="mailto:admin@outsourceaccountings.co.uk" target="_blank"><IoMdMail  className="inline-block mr-2   "/><span>admin@outsourceaccountings.co.uk</span></a></li>
          ...
          <div className="text-xs mt-8 text-center text-gray-400 ">
          <p>
          © 2024 Outsource Accounting. All rights reserved.
          </p>
          </div>
