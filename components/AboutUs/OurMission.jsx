  ...
  return (
    <section className='w-full flex justify-between items-start gap-8 px-20 mx-auto container py-8'>
        ...
        <div className='w-[50%]  max-w-[600px] '>
          <div className='mb-16'>
            <h2 className='text-[#6C63FF] font-poppins text-xl mb-8'>Our mission</h2>

            <p className='font-Inter text-black/75'>

            At Outsource Accounting, we’ve got a straightforward mission – we’re
here to hook you up with outstanding accounting services that fit your
needs like a glove. And guess what? We’re doing it all while keeping
things cheaper for you. We understand that juggling finances can be a bit
of a head-scratcher, so our goal is to make it as easy as a pie, super
efficient, and light on the wallet.
<br/>

<br/>


Think of us not only as your average accountants, but as your reliable
and trustworthy financial allies, prepared to sail you through all the twists
and turns of the financial ocean. Our goal is very clear: whether you’re
starting a new business, steering a growing business, or captaining an
established business, we’re here to give you the expertise and assistance
you need to succeed in the very competitive UK business market.
          ...
          <h2 className='text-[#6C63FF] font-poppins text-xl mb-8'>Our values</h2>
